...
public class GetTransactionByIdHandler(ITransactionRepository transactionRepository, ICategoryRepository categoryRepository)
    : IRequestHandler<GetTransactionByIdCommand, Response<TransactionDto?>>
{
    public async Task<Response<TransactionDto?>> Handle(GetTransactionByIdCommand request, CancellationToken cancellationToken)
    {
        try
        {
