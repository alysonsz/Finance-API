...
public class GetTransactionsByPeriodQueryHandler(ITransactionRepository transactionRepository)
    : IRequestHandler<GetTransactionsByPeriodCommand, PagedResponse<List<TransactionDto>?>>
{
    public async Task<PagedResponse<List<TransactionDto>?>> Handle(GetTransactionsByPeriodCommand request, CancellationToken cancellationToken)
    {
        try
        {
